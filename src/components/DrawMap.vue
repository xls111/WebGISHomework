...
export default {
  ...
  methods: {
    loading (args) {
      ...
      const layer = new this.gisConstructor.FeatureLayer({
        portalItem: {
      ...
      view.ui.add(
        new this.gisConstructor.Expand({
          view: view,
          content: infoDiv,
      ...
      view.whenLayerView(layer).then((layerView) => {
        ...
        const slider = new this.gisConstructor.Slider({
          min: 0,
          max: 2000,
          values: [0],
...
<style scoped>
/*@import 'https://js.arcgis.com/4.22/esri/themes/dark/main.css';*/
#viewDiv {
  height: 700px;
  width: 100%;
  margin: 0;
