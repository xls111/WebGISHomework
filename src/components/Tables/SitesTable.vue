...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        {field: 'id', key: 'a', title: '编号',titleAlign: 'center', columnAlign: 'center', isResize: true},
        {field: 'code', key: 'b', title: '地标编号',  titleAlign: 'center', columnAlign: 'center', isResize: true},
        {field: 'name', key: 'c', title: '地表名', titleAlign: 'center', columnAlign: 'center', isResize: true},
        ...
        {field: 'adname', key: 'f', title: '行政区',  titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'adcode', key: 'g', title: '地址代码', titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'address', key: 'h', title: '地址', titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'type', key: 'i', title: '类型', titleAlign: 'center', columnAlign: 'left', isResize: true}
      ],
      columns2:[
        ...
        // {field: 'lng', key: 'd', title: '经度', width: 30, titleAlign: 'center', columnAlign: 'left', isResize: true},
        // {field: 'lat', key: 'e', title: '纬度', width: 30, titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'adname', key: 'f', title: '地址', titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'adcode', key: 'g', title: '地址代码',titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'address', key: 'h', title: '地址', titleAlign: 'center', columnAlign: 'left', isResize: true},
        {field: 'type', key: 'i', title: '类型', titleAlign: 'center', columnAlign: 'left', isResize: true}
      ],
